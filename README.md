...
* **Features**:
  ...
  * **Supported Handlers out-of-the-box**:
    * **Mekanism**: Induction Matrix, Dynamic Tank, standalone Chemical Tank & Fluid Tank (any tier, incl. MekanismExtra), Fission Reactor, Industrial Turbine, Thermoelectric Boiler, Fusion Reactor, Supercritical Phase Shifter (SPS), Energy Cubes.
...
* `tank/<entity_name>` — Fluid and chemical tanks (Dynamic Tank, standalone Chemical/Fluid Tank)
